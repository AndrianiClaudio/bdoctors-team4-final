        ...
        <div class="row page m-0 p-0">
            <div class="col-2 m-0 p-0">
                <div class="row m-0 p-0">
                    <div class="col">
                        <h4 class="fw-bold border-bottom m-2 pb-2"> Filtra per: </h4>
                    </div>
                </div>
                <div class="row m-0 p-0">
                    <div class="col">
                ...
                <div class="row m-0 p-0">
                    <div class="col m-0 px-3">
                        <select class="select-spec m-0 mb-3"
            ...
            <div class="col-10 m-0 p-0">
                <div class="row m-0 mt-3 me-3 p-0">
                    <div class="col m-0 p-0 d-flex justify-content-end align-items-center">
                        <h5 class="m-0 mb-3"> <strong> <em> Numero </em> dottori </strong> rispettano i filtri selezionati</h5>
                    </div>
                </div>
                <div class="row m-0 p-0 mx-3">
                    <div class="col m-0 p-0">
                        <ul class="list-group" v-if="filteredDoctor.length > 0">
                            <li class="list-group-item" v-for="doctor in filteredDoctor" :key="doctor.id">
                                <div class="row m-0 p-0">
                                    <div class="col m-0 p-0 d-flex justify-content-center">
                                        <img class="rounded-circle" :src="doctor.photo" alt="">
                                    </div>
                                    <div class="col d-flex flex-column justify-content-around m-0 p-0">
                                        <div class="row m-0 p-0">
                                            <div class="col m-0 p-0">
                                                <div class="text-uppercase fw-bold text-lighter"
                                        ...
                                        <div class="row m-0 p-0">
                                            <div class="col m-0 p-0">
                                                Votazione (<em>numero</em> recensioni)
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col m-0 p-0">
                                        <ul  v-if="doctor.services">
                                            <li v-for="(service, index) in doctor.services" :key="`service-${index}`">
                                                {{ service.type }}
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col d-flex flex-column justify-content-around align-items-center m-0 p-0">
                                        <div class="row m-0 p-0">
                                            <div class="col">
                                                <router-link
